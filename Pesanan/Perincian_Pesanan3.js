      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.boxPaymentDeadline}>
          <View style={styles.rowPaymentDeadLine}>
            <Text style={styles.textPaymentDeadLine}>
              Sedang Dalam Perjalanan
            </Text>
          </View>
          <View style={styles.rowDeadline}>
            <Text style={styles.textTgl}>Estimasi Tiba</Text>
            <Text style={styles.textJam}>21 - 23 July</Text>
        ...
        <View style={styles.boxIsiRincianPesanan}>
          ...
          <View style={styles.rowIsiPesanan}>
            <Text style={styles.textIsiPesanan}>Tanggal Pengiriman</Text>
            <Text style={styles.textIsiPesanan}>20 Juni 2021</Text>
          </View>
          <View style={styles.rowIsiPesanan2}>
            <Text style={styles.textIsiPesanan1}>Nomor Resi JNE</Text>
            <TouchableOpacity>
              <Image
                source={require('../../Image/salin2.png')}
                style={{
                  width: 20,
                  height: 20,
                  resizeMode: 'contain',
            ...
            <Text style={styles.textIsiPesanan}>JX0200002929</Text>
          </View>
        </View>
        <View style={styles.boxRincianPesanan}>
...
export default PerincianPesananPage3;
